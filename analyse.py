...
class Analysis:
    def __init__(self,df,is_init=False):
    ...
    def init_data(self):
        v = self.low[0]
        self.high = (self.high-v)/v
        self.low = (self.low-v)/v
        self.open = (self.open-v)/v
        self.close= (self.close-v)/v
        self.volume= self.volume-self.volume[0]
